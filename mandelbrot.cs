...
namespace csharp_func
{
  public class MandelBrot
  {
      ...
      public static unsafe int MainOld()
      {
          var size = 16000;
      ...
      public static int mandel()
      {
          if (false)//(System.Runtime.Intrinsics.X86.Avx2.IsSupported)
              return MandelBrot.MainNew();
          else
              return MandelBrot.MainOld();
      }
  }
    public static class mandelbrot
    {
        [FunctionName("mandelbrot")]
        public static IActionResult Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequest req,
            ILogger log)
        {

            string responseMessage = MandelBrot.mandel().ToString();
